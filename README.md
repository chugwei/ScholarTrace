...
最新发布版本为 `v0.0.1`。当前 M1 开发分支已实现研究问题、项目 State、Reducer、SQLite Project Repository、Alembic 初始迁移、带 SQLite Checkpointer 的固定顺序 LangGraph，以及创建、继续和查看项目的 CLI；独立进程恢复验收仍在进行。文献检索、实验执行、论文生成和部署尚未实现，不能视为可用能力。
