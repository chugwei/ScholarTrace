...
| M8 Runner 与排错 | v0.8.0 | release-candidate | feat/m8-runner-debugging | — | M8.4.2 发布候选审查中，尚未合并 main |
...
| M8.4 | MLflow/DVC 初步集成、独立审查和 `v0.8.0` 发布 | 3 个适配器目标测试；发布候选审查中 | release-candidate |
